...
test('phase 3 TS status route registers and serves a status payload', async () => {
...
test('phase 3 TS persistent routes register expected endpoints and cookie parser', async () => {
...
test('phase 3 TS activity registry exports expected API surface', async () => {
  const module = await importTsModule<{
