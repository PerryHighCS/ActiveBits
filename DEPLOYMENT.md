...
- **JSON request body budget**: Most routes keep Express's default JSON body limit. Only `/api/mobcode` uses a `5mb` parser budget, and MobCode file-state payloads are capped lower at `4 MiB` after parsing.
