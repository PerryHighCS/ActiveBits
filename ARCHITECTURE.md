...
- **Linked-session keepalive**: A session may refresh one directly linked session on genuine activity; the relationship is deliberately single-hop to keep cycles safe.
