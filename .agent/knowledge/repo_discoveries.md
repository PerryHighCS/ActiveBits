...
- Date: 2026-05-12
- Area: server | tooling | dependencies
...
- Follow-up action: Keep server dependency updates on Node 24+ environments and re-run server workspace checks when touching proxy config.
- Owner: Codex
