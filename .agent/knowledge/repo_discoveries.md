...
- Follow-up action: Keep future SyncDeck host relay changes split between explicit boundary grants (`setStudentBoundary`) and follow-mode snapbacks (`syncToInstructor`) instead of reintroducing command-specific compatibility flags.
- Owner: Codex
