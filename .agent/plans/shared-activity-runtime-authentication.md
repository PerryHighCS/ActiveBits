...
- [ ] Move SyncDeck's remaining student WebSocket admission and student-ID HTTP routes to the shared principal contract; child-token issuance is gated now, but other student state still accepts a client-selected ID.
