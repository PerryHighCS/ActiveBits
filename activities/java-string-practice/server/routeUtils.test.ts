...
test('validateStudentName trims and enforces allowed characters', () => {
...
test('validateStats clamps invalid fields and preserves invariants', () => {
...
test('validateMethods returns defaults for empty/invalid lists', () => {
