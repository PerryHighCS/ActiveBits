...
void test('buildBrythonRunnerHtml runs user code in a Brython worker', () => {
  ...
  assert.match(html, /worker_self\.mobcodeResolveInputFuture\(input_future, str\(message\.get\('value', ''\)\)\)/)
...
void test('buildBrythonRunnerHtml wires terminal input through async worker messages', () => {
  ...
  assert.match(html, /worker_self\.mobcodeResolveInputFuture\(input_future,/)
