...
void test('resolveRaffleSelectionSize enforces group minimum and upper bound behavior', () => {
...
void test('resolveRaffleSelectionSize preserves non-group counts when available', () => {
  assert.equal(resolveRaffleSelectionSize(1, 3), 1)
  assert.equal(resolveRaffleSelectionSize(2, 1), null)
})

void test('drawWinningTickets returns unique winners from ticket pool', () => {
...
void test('drawWinningTickets caps winner count to available tickets', () => {
