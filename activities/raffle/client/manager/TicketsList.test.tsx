...
void test('isTicketToggleKey accepts keyboard activation keys only', () => {
...
void test('ticket items expose button semantics for keyboard and assistive technologies', () => {
